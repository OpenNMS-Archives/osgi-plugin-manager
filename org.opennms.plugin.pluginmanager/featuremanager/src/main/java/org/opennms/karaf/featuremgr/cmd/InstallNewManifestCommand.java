...
public class InstallNewManifestCommand extends OsgiCommandSupport {
	...
	@Argument(index = 0, name = "manifest", description = "comma seperated definition of manifest of featureIds. e.g. featureA,featureB/1.0.0-SNAPSHOT", required = true, multiValued = false)
