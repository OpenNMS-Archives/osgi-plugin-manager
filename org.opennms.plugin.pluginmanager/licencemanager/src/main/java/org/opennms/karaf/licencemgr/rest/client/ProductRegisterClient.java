...
public interface ProductRegisterClient {
	 ...
	 * e.g. http://localhost:8181/licencemgr/rest/v1-0/product-pub/removeproductspec?productId=
	 * 
	 * @param productId
	 * @throws Exception
	 */
	 ...
	 * 
	 * e.g. http://localhost:8181/licencemgr/rest/v1-0/product-pub/getproductspec?productId=
	 * 
	 * @param productId
	 ...
	 * 
	 * e.g. http://localhost:8181/licencemgr/rest/v1-0/product-pub/list
	 * 
	 ...
	 * 
	 * e.g. http://localhost:8181/licencemgr/rest/v1-0/product-pub/clearproductspecs?confirm=false
	 * 
	 * @param confirm
	 * @throws Exception
	 */
