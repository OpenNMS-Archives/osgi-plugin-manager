...
public class PluginManagerUIMainPanel extends CustomComponent {
	...
	@AutoGenerated
	private VerticalLayout localAvailablePluginsTab;

	@AutoGenerated
	private ProductDescriptorTablePanel localAvailablePluginsPanel;
	...
	@AutoGenerated
	private PasswordField pluginServerPasswordTxtField;
	...
	private AvailablePluginControlsPanel  localAvailablePluginsControlsPanel;
	...
	public void updateDisplayValues(){
		...
		try{
			...
			ProductSpecList localAvailablePluginsList = sessionPluginManager.getLocalAvailablePlugins();
			localAvailablePluginsPanel.addProductList(localAvailablePluginsList);
	...
	private HorizontalLayout buildHorizontalLayout_2() {
		...
		reloadAvailablePluginsButton.setCaption("Reload Remote Available Plugins");
	...
	private VerticalLayout buildPluginServerConfigPanel() {
		...
		pluginServerConfigPanel.setCaption("Remote Available Plugins Server Settings");
		...
		pluginServerUrlTxtField.setCaption("Remote Plugin Server URL");
	...
	private HorizontalLayout buildHorizontalLayout_6() {
		...
		updatePluginServerButton.setCaption("Update Remote Plugin Server Settings");
	...
	private VerticalLayout buildVerticalLayout_3() {
		...
		pluginServerUsernameTxtField.setCaption("Remote Plugin Server Username");
		...
		pluginServerPasswordTxtField = new PasswordField();
		pluginServerPasswordTxtField.setCaption("Remote Plugin Server Password");
	...
	private TabSheet buildFeaturesTabSheet_1() {
		...
		// localAvailablePluginsTab
		localAvailablePluginsTab = buildLocalAvailablePluginsTab();
		featuresTabSheet_1.addTab(localAvailablePluginsTab,
				"Local Available Plugins", null);
		
		// availablePluginsTab
		availablePluginsTab = buildAvailablePluginsTab();
		featuresTabSheet_1.addTab(availablePluginsTab, "Remote Available Plugins",
				null);
	...
	private VerticalLayout buildAvailablePluginsTab() {
		...
		availablePluginsPanel
				.setCaption("Plugins available from Remote Plugin Server ");
	...
	@AutoGenerated
	private VerticalLayout buildLocalAvailablePluginsTab() {
		// common part: create layout
		localAvailablePluginsTab = new VerticalLayout();
		localAvailablePluginsTab.setImmediate(true);
		localAvailablePluginsTab.setWidth("-1px");
		localAvailablePluginsTab.setHeight("-1px");
		localAvailablePluginsTab.setMargin(true);
		localAvailablePluginsTab.setSpacing(true);
		
		// localAvailablePluginsPanel
		localAvailablePluginsPanel = new ProductDescriptorTablePanel();
		localAvailablePluginsPanel
				.setCaption("Plugins available from local repository ");
		localAvailablePluginsPanel.setImmediate(true);
		localAvailablePluginsPanel.setWidth("100.0%");
		localAvailablePluginsPanel.setHeight("100.0%");
		localAvailablePluginsTab.addComponent(localAvailablePluginsPanel);
		
		return localAvailablePluginsTab;
	}
